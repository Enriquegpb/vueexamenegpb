<template>
  <div v-for=" c in cubos" :key="c.idCubo" style="display: inline-flex;">
    <div class="card" style="width: 18rem;">
        <img :src="c.imagen" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">{{c.nombre}}</h5>
          <p class="card-text">{{c.precio}}</p>
          <button class="btn btn-dark" @click="verComentarios(c.idCubo)">Comnetarios</button>
          <router-link to="/" class="btn btn-primary">Go somewhere</router-link>
        </div>
      </div>
</div>
<h1>Comentarios</h1>
<div v-for="c in comentarios" :key="c.idComentario">
